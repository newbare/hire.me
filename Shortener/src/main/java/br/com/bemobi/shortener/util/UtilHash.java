...
/**
* Based on Hashids designed for Generating short hashes from numbers (like YouTube and Bitly), obfuscate
...
public class UtilHash {
  ...
  public UtilHash(final String salt) {
    this(salt, 0);
  }

  public UtilHash(final String salt, final int minHashLength) {
    this(salt, minHashLength, DEFAULT_ALPHABET);
  }

  public UtilHash(final String salt, final int minHashLength, final String alphabet) {
    this.salt = salt;
    if(minHashLength < 0)
...
*/
  ...
  public Long decryptForLong(final String hash){
	    if(hash.equals("")) {
	        return new Long(0l);
	    }
	    long[] ret = this.decode(hash, this.alphabet);
	    return ret[0];
	  }
